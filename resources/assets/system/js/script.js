$(document).ready(function () {
    ...
    //         let urlEdit = "{{ URL::to('/branch-edit/" + branch.id + "') }}";
    //         let srcImgEdit = "{{ asset('resources/assets/system/img/icons/edit.svg') }}";
    //         let srcImgDelete = "{{ asset('resources/assets/system/img/icons/delete.svg') }}";
    ...
    //     let province = $('#branch-filter-province').val();
