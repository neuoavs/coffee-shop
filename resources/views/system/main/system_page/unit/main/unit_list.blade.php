  ...
  <div class="content">
    <div class="page-header">
      <div class="page-title">
        <h4>Unit List</h4>
        <h6><strong>Unit</strong>/Unit List</h6>
      </div>
      <div class="page-btn">
        <a href="{{URL::to('/unit-add')}}" class="btn btn-added">
          <img
    ...
    <div class="card">
      <div class="card-body">
        {{-- Print page --}}
        @include('system.main.system_page.unit.elements.unit_search')
        {{-- End print page --}}

        {{-- Search page --}}
        @include('system.main.system_page.unit.elements.unit_filter')
        {{-- End search page --}}
        
        {{-- Table page --}}
        @include('system.main.system_page.unit.elements.unit_table')
        {{-- End table page --}}
      </div>
    </div>
  </div>
...
<script src="{{asset('resources/assets/system/js/unit-filter.js')}}"></script>
@endsection