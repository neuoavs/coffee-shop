  ...
  <div class="content">
    <div class="page-header">
      <div class="page-title">
        <h4>Branch Employee List</h4>
        <h6><strong>Branch Employee</strong>/Branch Employee List</h6>
      </div>
      <div class="page-btn">
        <a href="{{URL::to('/branch-employee-add')}}" class="btn btn-added">
          <img
    ...
    <div class="card">
      <div class="card-body">
        {{-- Print page --}}
        @include('system.main.system_page.branch_employee.elements.branch_employee_search')
        {{-- End print page --}}

        {{-- Search page --}}
        @include('system.main.system_page.branch_employee.elements.branch_employee_filter')
        {{-- End search page --}}
        
        {{-- Table page --}}
        @include('system.main.system_page.branch_employee.elements.branch_employee_table')
        {{-- End table page --}}
      </div>
    </div>
  </div>
...
<script src="{{asset('resources/assets/system/js/branch-employee-filter.js')}}"></script>
@endsection